...
const INITIAL_LIMIT = 50; // Cte para el limite inicial de carga
        ...
        <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '20px' }}>
                ...
                {pokemonListData?.map((pokemon) => {
                    // Determina si este item es favorito usando el Set
            ...
            >
                {isLoadMoreLoading ? 'Cargando...' : 'Cargar más Pokemons (50 adicionales)'}
            </button>
        </div>
    );
}